...
-   Reorganize some of the content according to the new split across breaks
...
-   Style and streamline the DADA2 tutorial

-   Replace samples for phyloseq intro and alpha diversity with the DADA2 processed samples.
...
-   microViz bug fixes if there's time

    -   bad default ranks on taxatree_plots

    -   noisy new taxatree_plot_labels filter deprecation warnings

    -   shiny warnings since 4.2 - requires dev version of shiny?
        or setting hidden option for strictness?
...
-   DADA2 denoising: Adapt the 2020 tutorial to my style and streamline/compress it.

-   End on intro to phyloseq and microViz
