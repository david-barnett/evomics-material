...
::: notes
Okay. So before the break we processed some amplicon sequencing data with DADA2. 
...
::: notes
But sadly we don't have enough distinct colours to label all the unique taxa, 
we can show them like this. There's a lot.
:::
